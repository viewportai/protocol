...
export const CONTRACTS = [
    {
        ...
        notes: 'Implemented by daemon workflow parser and platform workflow-core/PHP validation family. Web projection fixture is still pending.',
    },
    {
        key: 'repoConfig',
        ...
        notes: 'Validated against daemon ViewportConfigSchema with version: 1. The schema: viewport.repo_config/v1 field is a Batch A protocol overlay accepted by the daemon passthrough parser.',
    },
    {
        key: 'route',
        ...
        platformCompatibility: 'validated',
        webCompatibility: 'pending',
        notes: 'Protocol package validates route shape. Platform stores route versions, validates ready resolve targets, projects latest-ready versions, and proves disabled routes fail closed during route-table matching.',
    },
    {
        ...
        platformCompatibility: 'validated',
        webCompatibility: 'pending',
        notes: 'Protocol package validates execution profile shape. Platform stores execution profile versions, validates runner pool targets, snapshots profile identity into runs, and proves disabled profiles fail closed after route matching.',
    },
    {
        key: 'runnerWorkspace',
    ...
    },
    {
        ...
        platformCompatibility: 'validated',
        webCompatibility: 'pending',
        notes: 'Protocol package validates evidence packet shape. Platform stores evidence packets and daemon emits first-pass node-output evidence; provider-normalized evidence quality remains pending.',
    },
    {
        key: 'actionProposal',
        ...
        platformCompatibility: 'validated',
        webCompatibility: 'pending',
        notes: 'Protocol package validates action proposal shape. Platform stores first-class action proposals, daemon emits proposals from local runs, and approvals are digest-bound.',
    },
    {
        ...
        platformCompatibility: 'validated',
        webCompatibility: 'pending',
        notes: 'Protocol package validates authorization decision shape. Platform stores and replays authorization decisions as first-class workflow run records; daemon/runtime emission and policy-engine decision recording remain pending.',
    },
    {
    ...
    },
    {
        ...
        platformCompatibility: 'validated',
        webCompatibility: 'pending',
        notes: 'Protocol package validates context receipt shape. Daemon context-node resolution emits provider usage receipts and platform persists/replays/health-checks them. First-class context package governance remains pending.',
    },
    {
        key: 'auditReceipt',
        ...
        platformCompatibility: 'validated',
        webCompatibility: 'pending',
        notes: 'Protocol package validates audit receipt shape. Platform stores audit receipts and daemon emits first-pass audit receipts; tamper-evident receipt linkage remains pending.',
    },
];
export function contractBySampleFile(sampleFile) {
    return CONTRACTS.find((contract) => contract.sampleFile === sampleFile);
}
export function implementedContracts() {
    return CONTRACTS.filter((contract) => contract.status === 'implemented');
}
export function targetOnlyContracts() {
