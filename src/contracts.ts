...
export const CONTRACTS = [
  ...
  },
  {
    ...
    webCompatibility: 'pending',
    notes:
      'Protocol validates the target package shape, including source-of-truth mode, typed memory objects, relations, and update governance. Platform/daemon package registry semantics are not implemented.',
  },
  {
    key: 'agentEvent',
  ...
  },
  {
    ...
    webCompatibility: 'pending',
    notes:
      'Protocol package validates approval-bound execution grant shape. Platform mints grants for approved proposal-backed side effects and daemon carries them into execution receipts.',
  },
  {
    ...
    webCompatibility: 'pending',
    notes:
      'Protocol package validates execution receipt shape. Platform stores execution receipts, daemon emits success/failure/dead-letter receipts, and managed action replay completion creates execution receipts.',
  },
  {
    key: 'contextReceipt',
    ...
    webCompatibility: 'pending',
    notes:
      'Protocol package validates context receipt shape. Daemon context-node resolution emits provider usage receipts and platform persists/replays/health-checks them. First-class context package governance remains pending.',
  },
  {
    key: 'auditReceipt',
